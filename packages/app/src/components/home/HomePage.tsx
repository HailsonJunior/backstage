            ...
            <Grid container item xs={12}>
              <Grid item xs={12} md={6}>
                ...
                <Grid item xs={12} md={6}>
                  ...
                  tools={[
                    {
                    url: 'https://github.com/HailsonJunior/backstage',
                    label: 'Backstage GitHub',
                    icon: <TemplateBackstageLogoIcon />, // Replace with your custom icon
                    },
                    {
                    url: 'https://www.notion.so',
                    label: 'Notion',
                    icon: <NotionIcon />, // Replace with your custom icon component
                    },
                    {
                    url: 'https://about.gitlab.com',
                    label: 'GitLab',
                    icon: <GitLabIcon />, // Replace with your custom icon component
                    },
                    {
                      url: 'https://argoproj.github.io',
                      label: 'Argo',
                      icon: <ArgoIcon />, // Replace with your custom icon component
                      },
                  ]}
                  />
                </Grid>
